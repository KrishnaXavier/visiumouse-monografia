...
%% REVDEIA 1: coloca o site como nota de rodapé, assim: \footnote{REVDEIA: http://  COLOCAR AQUI O SITE } .

%% REVDEIA 2: Não inicia frases com siglas, escreva por extenso

%% REVDEIA 3: AQUI FALTA A REFERÊNCIA SOBRE VISÃO COMPUTACIONAL
...
%Esse Capítulo apresenta os conceitos de TA e VC e as motivações para o trabalho apresentado. 
...
%% REVDEIA 5: TODO ESTE PARÁGRAFO ABAIXO ESTÁ REPETIDO
...
%% REVDEIA 7: COLOCA NA FORMA DE ITENS 
...
%% COLOCA NA FORMA DE ITENS - E NÃO TENS COMO CITAR REFERÊNCIA DE CADA UM
...
%% REVDEIA 8: também é da mesma referência de VC ? aqui quando defines os tipos de imagens precisa inserir referência, de onde tiraste? compreendes?
...
%% REVDEIA 9 : LER EM VOZ ALTA E CORRIGIR : ..., acurácia do classificado e ... ? ? ?  NÃO ENTENTI
...
%% REVDEIA 10: FAZER EM FORMA DE ITENS
...
%% REVDEIA 11: aqui precisa ser um subcapítulo, precisas desvincular do FHCI
%% TALVEZ LEVA O RESTANTE DO TEXTO LÁ PARA O CAPÍTULO REFERENTE AO VISIUMOUSE
...
%% REVDEIA N : quem sabe alterar o nome para ARQUITETURA
...
%% REVDEIA : AQUI QUEM SABE RENOMEAR PARA COMPARAÇÃO COM SOLUÇÕES ANÁLOGAS, PORQUE PARECE SINÔNIMO AOS TRABALHOS RELACIONADOS
