...
A última atualização da classificação das TA é de 2017. 
De acordo com \cite{bersch2008introduccao}, ela tem uma finalidade didática e cada categoria considera a existência de recursos e serviços e a importância das classificações no âmbito da TA se dá pela promoção da organização desta área de conhecimento e servirá ao estudo, pesquisa, desenvolvimento, promoção de políticas públicas, organização de serviços, catalogação e formação de banco de dados para identificação dos recursos mais apropriados ao atendimento de uma necessidade funcional do usuário final.

Conforme \citeonline{bersch2008introduccao}, podemos categorias as TA em:
